...
void main(void)
{
	...
	out_Color = (0.2+dominance) * (
	              texture2D(nebulae1, space * 0.036).r *0.5
	            + texture2D(star_brightness, space2 * 0.016).r *0.25
	            + texture2D(nebulae2, space1 * 0.016).r * 0.4
	            + 0.1);
	
	float starLayer0 = texture2D(stars, space * 0.5).r * (texture2D(star_brightness, space * 0.096).r * 2.85 + 0.4);
	float starLayer1 = texture2D(stars, space1 * 0.5).r * (texture2D(star_brightness, space1 * 0.12).r * 2.85 + 0.4);
	float starLayer2 = texture2D(stars, space2 * 0.5).r * (texture2D(star_brightness, space2 * 0.35).r * 2.0 + 0.4);
	float starLayer3 = texture2D(stars, space3 * 0.5).r * (texture2D(star_brightness, space3 * 0.23).r * 1.8 + 0.4);
